...
function Clock() {
    ...
    const a = date.getHours().toLocaleString("ru-RU")
        const b = date.getMinutes().toLocaleString("ru-RU")
    const stringTime = a + ":" + b|| <br/> // часы24:минуты:секунды (01:02:03)/(23:02:03)/(24:00:00)/(00:00:01) // пишут студенты
